...
const novaPromocao = async function (promocao){
    if(promocao.nome == '' || promocao.nome == undefined || promocao.descricao == '' || promocao.descricao == undefined ||promocao.valor == '' || promocao.valor == undefined || promocao.imagem == '' || promocao.imagem == undefined)
    {
